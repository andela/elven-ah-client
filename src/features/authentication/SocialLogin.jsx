...
const SocialLogin = () => (
  <div className="social col-md-6 pt-4">
    ...
    <div className="text-center mb-1">
      <Link to="/"><img className="mb-2 mt-2" src={btnFacebook} alt="logo" width="250" height="59" /></Link>
    </div>
    <div className="text-center mb-1">
      <Link to="/"><img className="mb-2 mt-2" src={btnTwitter} alt="logo" width="250" height="59" /></Link>
    </div>
    <div className="text-center mb-1">
      <Link to="/"><img className="mb-2 mt-2" src={btnGoogle} alt="logo" width="250" height="59" /></Link>
    </div>
  </div>
);
