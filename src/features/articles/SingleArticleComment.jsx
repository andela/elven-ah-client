...
import SingleArticleCommentReply from './SingleArticleCommentReply';
import SingleArticleCommentReplyForm from './SingleArticleCommentReplyForm';

/* eslint-disable react/no-array-index-key */
const SingleArticleComment = () => (
  <React.Fragment>
      ...
      <div className="media g-mb-30 media-comment">
        <div className="media-body u-shadow-v18 g-bg-secondary g-pa-30">
          ...
          <ul className="list-inline d-sm-flex my-0">
            ...
            <li className="list-inline-item ml-auto single-article-comment-reply">
              <Link className="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover" to="a">
                <i className="fa fa-reply g-pos-rel g-top-1 g-mr-3 single-article-like-unlike" />
                    Reply
              </Link>
            </li>
          </ul>
          <div className="row">
            <SingleArticleCommentReplyForm />
          </div>
          <SingleArticleCommentReply />
        </div>
